...
Removed:
========
* Remove duplicated fix with upstream in profile (RGOeX-26109)
* Remove duplicated fix with upstream for RTL, dates and unused styles in learning (RGOeX-26110)
* Remove duplicated fix with upstream for trimming long text in the social networks block in account (RGOeX-26108)
